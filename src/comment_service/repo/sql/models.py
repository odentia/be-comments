...
class CommentModel(Base):
    ...
    # Relationships
    parent: Mapped["CommentModel | None"] = relationship("CommentModel", remote_side=[id], back_populates="children")
    children: Mapped[list["CommentModel"]] = relationship("CommentModel", back_populates="parent", cascade="all, delete-orphan")
    reactions: Mapped[list["CommentReactionModel"]] = relationship("CommentReactionModel", back_populates="comment", cascade="all, delete-orphan")
